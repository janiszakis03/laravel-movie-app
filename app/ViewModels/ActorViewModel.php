    ...
    public function credits()
    {
        ...
        return collect($castMovies)->map(function($movie) {
            ...
            return collect($movie)->merge([
               ...
               'release_year' => isset($releaseDate) ? Carbon::parse($releaseDate)->format('Y') : 'Future', //Liek isset(), lai pārbaudītu vai vispār tāds mainīgais ir uzsetots/uzstādīts/izveidots, jo ja tikai pārbaudīs tā vērtību bez isset(), uzmetīs error kad tas nebūs uzstādīts. isset() - is set
               'title' => $title,
